...
#' 
#' @return Output is a plot of water level depth
#' 
#' @export
...
marsWaterLevelPlot <- function(event, 
  ...
  obs_plot <- 
    ...
    geom_hline(yintercept = 0, color = "black", size = 1.2)+ #bottom
    
    geom_hline(yintercept = storage_depth_ft, color = "orange", size = 1.2)+ #top
